// Updated login.dart with GoRouter navigation
...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  final String adminEmail = 'admin@manilaserve.gov.ph';
  ...
  void _handleLogin() {
    if (_formKey.currentState!.validate()) {
      ...
      if (email == adminEmail.toLowerCase()) {
        context.go('/admin-dashboard'); // Fixed navigation
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              context.go('/forgot-password'); // Fixed navigation
                            },
                            child: Text(
                              'Forgot Password?',
                              style: TextStyle(
                        ...
                        Center(
                          child: GestureDetector(
                            onTap: () {
                              context.go('/signup'); // Fixed navigation
                            },
                            child: RichText(
                              text: TextSpan(
                        ...
                        Center(
                          child: Padding(
                            ...
                            child: Text(
                              'Admin? Use: admin@manilaserve.gov.ph',
                              style: TextStyle(
